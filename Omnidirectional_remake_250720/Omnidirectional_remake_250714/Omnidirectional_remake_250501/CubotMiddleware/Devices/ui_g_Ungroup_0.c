...
void _ui_init_g_Ungroup_0() {
    ...
    ui_g_Ungroup_NewLine->start_x = 1495;
    ui_g_Ungroup_NewLine->start_y = 664;
    ui_g_Ungroup_NewLine->end_x = 1527;
    ui_g_Ungroup_NewLine->end_y = 664;
    ui_g_Ungroup_NewLine->color = 2;
...
void _ui_update_g_Ungroup_0() {
    for (int i = 0; i < OBJ_NUM; i++) {
		...
		ui_g_Ungroup_NewLine->start_y = 393 + (664 - 393) * (500 - Load_Number)/500;
		ui_g_Ungroup_NewLine->end_y = 393 + (664 - 393) * (500 - Load_Number)/500;
