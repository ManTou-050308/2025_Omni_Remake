...
static void MotorEcdtoAngle(Motor* motor)
{
	...
	float angle1;
	if(motor->Data.Angle-motor->Data.Last_Angle>300)
	{

		angle1=motor->Data.Angle-motor->Data.Last_Angle-360;
	}
	else if(motor->Data.Angle-motor->Data.Last_Angle<-300)
	{
	...
	{
		angle1=motor->Data.Angle-motor->Data.Last_Angle;
	}
	motor->Data.Last_Angle =motor->Data.Angle;
	motor->Data.Total_Target += angle1;
...
//static void MotorEcdtoAngle_360(Motor* motor)
//{
//	
//	if((&motor->Param)->EcdOffset < ((&motor->Param)->EcdFullRange/2))
//	{
...
//	{
//	(&motor->Data)->Angle = (&motor->Data)->Angle +360;
//	
